...
Route::post('/cart/checkout', [PublicMenuController::class, 'checkoutCart'])->name('public.menus.checkout_cart');
Route::match(['get', 'post'], '/shop/{menu}', [PublicMenuController::class, 'checkout'])->name('public.menus.checkout');
